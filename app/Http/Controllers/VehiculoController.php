...
class VehiculoController extends Controller
{
    ...
    public function index()
    {
        ...
        $tipovehiculos = App\Tipovehiculo::orderby('nombretipoveh', 'asc')->get();
        return view('vehiculo.index', compact('parqueaderos','vehiculos','tipovehiculos'));
    }
    ...
    public function edit($id)
    {
        ...
        $parqueaderos = App\Parqueadero::orderby('id', 'asc')->get();
        $tipovehiculos = App\Tipovehiculo::orderby('nombretipoveh', 'asc')->get();
        return view('vehiculo.edit', compact('vehiculo','parqueaderos','tipovehiculos'));
    }
