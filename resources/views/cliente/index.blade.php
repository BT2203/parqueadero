        ...
        <form action="{{route('cliente.store')}} " method="post" autocomplete="off" class="form-horizontal">
            ...
            <div class="card-body ">
              ...
              <div class="row">
                ...
                <br>
                <div class="row">
                    <label class="col-sm-2 col-form-label">Nombres y Apellidos Cliente</label>
                    <div class="col-sm-7">
                        <input type="text" class="form-control" name="nombre_apellido" placeholder="{{ __('Nombres y Apellidos') }}"  />
                    </div>
                </div>
                <br>
                <div class="row">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-7">
                        <select name="idTipodoc" class="form-control" >
                          <option value="" disabled selected date-placeholder="">Selecciona Tipo Documento</option>
                            @foreach ($tipodocumentos as $tipodocumento)                           
                            <option value="{{$tipodocumento->id}}">{{$tipodocumento->nombretipodoc}}</option>
                            @endforeach
