                ...
                <div class="card ">
                    ...
                    <div class="card-body ">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-7">
                                <select name="idTipovehiculo" class="form-control" >
                                    <option value="" disabled selected date-placeholder="">Selecciona Tipo Vehiculo</option>
                                    @foreach ($tipovehiculos as $tipovehiculo)
                                    <option value="{{$tipovehiculo->id}}">{{$tipovehiculo->nombretipoveh}}</option>
                                    @endforeach
